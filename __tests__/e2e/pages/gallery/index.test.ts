...
test.describe('GalleryPage', async () => {
  ...
  test('it should render the most popular images by default', async ({ page }) => {
    expect(page.locator("button:has-text('Popularity')")).toHaveClass('btn-active');
    expect(page.locator("button:has-text('Newest first')")).not.toHaveClass('btn-active');
    expect(page.locator("button:has-text('Oldest first')")).not.toHaveClass('btn-active');
  ...
  test('it should render the newest images', async ({ page }) => {
    ...
    expect(page.locator("button:has-text('Popularity')")).not.toHaveClass('btn-active');
    expect(page.locator("button:has-text('Newest first')")).toHaveClass('btn-active');
    expect(page.locator("button:has-text('Oldest first')")).not.toHaveClass('btn-active');
  ...
  test('it should render the oldest images', async ({ page }) => {
    ...
    expect(page.locator("button:has-text('Popularity')")).not.toHaveClass('btn-active');
    expect(page.locator("button:has-text('Newest first')")).not.toHaveClass('btn-active');
    expect(page.locator("button:has-text('Oldest first')")).toHaveClass('btn-active');
